...
public class Item
{
	...
	public string CloneEquipStatusEffect = "";
	...
	public void AddEquipStatusEffect(StatusEffect statusEffect)
	{
		ItemDrop.ItemData.SharedData data = Prefab.GetComponent<ItemDrop>().m_itemData.m_shared;
		data.m_equipStatusEffect = statusEffect;
	}

	public void AddAttackStatusEffect(StatusEffect statusEffect)
	{
		ItemDrop.ItemData.SharedData data = Prefab.GetComponent<ItemDrop>().m_itemData.m_shared;
		data.m_attackStatusEffect = statusEffect;
	}
	...
	public void AssignItemEffects()
	{
		...
		UpdateEffects(AttackEffects, ref component.m_itemData.m_shared.m_attack.m_startEffect);
	}
...
public static class PrefabManager
{
	...
	{
		var asset = assets.LoadAsset<GameObject>(prefabName);
		if (asset is null) Debug.LogWarning(prefabName + " is null");
		return RegisterPrefab(asset, addToObjectDb);
	}
